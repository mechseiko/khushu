...
function j(n, r) {
  ...
  for (var t = 0, i = new Array(r); t < r; t++) i[t] = n[t];
  return i;
}
function L(n, r) {
...
function O() {}
var x = { type: 'SKIP_WAITING' };
function S(n, r) {
  return n && n.then ? n.then(O) : Promise.resolve();
}
var U = (function (n) {
  function r(v, u) {
    var e, o;
    return (
      ...
      (e.ln = function (s) {
        var a = e.fn,
          ...
          p = f.state,
          m = f === e.vn,
          y = { sw: f, isExternal: m, originalEvent: s };
        (!m && e.mn && (y.isUpdate = !0),
      ...
      (e.gn =
        ((o = function (s) {
          var a = s.data,
            f = s.ports,
            p = s.source;
          return d(e.getSW(), function () {
            e.an.has(p) &&
              e.dispatchEvent(
                new g('message', { data: a, originalEvent: s, ports: f, sw: p })
              );
          });
        }),
        function () {
  ...
  return (
      ...
      try {
        ...
        return d(
          (function (s, a) {
            ...
            function () {
              return (
                (o.mn = !!navigator.serviceWorker.controller),
                (o.dn = o.pn()),
                d(o.bn(), function (s) {
                  ((o.fn = s),
                    o.dn &&
                      ...
                      o.en.resolve(o.dn),
                      o.on.resolve(o.dn),
                      o.dn.addEventListener('statechange', o.ln, {
                        once: !0,
                      })));
                  var a = o.fn.waiting;
                  return (
                    a &&
                      b(a.scriptURL, o.sn.toString()) &&
                      ((o.hn = a),
                      Promise.resolve()
                        .then(function () {
                          o.dispatchEvent(
                        ...
                        .then(function () {})),
                    o.hn && (o.rn.resolve(o.hn), o.an.add(o.hn)),
    ...
    (l.messageSW = function (v) {
      try {
        return d(this.getSW(), function (u) {
          return E(u, v);
        });
      } catch (u) {
    ...
    (l.messageSkipWaiting = function () {
      this.fn && this.fn.waiting && E(this.fn.waiting, x);
    }),
    (l.pn = function () {
      ...
      try {
        ...
        return d(
          (function (u, e) {
            ...
            function () {
              return d(
                navigator.serviceWorker.register(v.sn, v.nn),
                function (u) {
  ...
  (function () {
    ...
    return (
      ...
      (r.dispatchEvent = function (t) {
        t.target = this;
        for (var i, c = L(this.jn(t.type)); !(i = c()).done; ) (0, i.value)(t);
      }),
      (r.jn = function (t) {
